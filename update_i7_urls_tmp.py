...
ORG_NAME        = "Portal-CF"
OLD_URL         = "https://i71.wdf.sap.corp"
NEW_URL         = "https://i71.bss.net.sap"
BRANCH_NAME     = "BLDXWZ-2501-fix-i7-url"
COMMIT_MESSAGE  = "Update URL for i7"
PR_TITLE        = "[BLDXWZ-2501]-fix-i7-url"
PR_BODY         = "Replaces `https://i71.wdf.sap.corp` → `https://i71.bss.net.sap`"

# WORK_DIR        = os.path.expanduser("~/git-i7")
SCAN_EXTENSIONS = {".json", ".yml", ".yaml", ".groovy", ".md"}
LOGS_DIR        = os.path.join(os.getcwd(), "logs")
# LOG_FILE        = os.path.join(WORK_DIR, f"update_i7_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
